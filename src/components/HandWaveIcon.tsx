/**
 * Phosphor "hand-waving" (regular), inlined. MIT licensed.
 * Inherits color via currentColor and sizes to 1em.
 */
export function HandWaveIcon({ className, style }: { className?: string; style?: React.CSSProperties }) {
  return (
    <svg
      className={className}
      style={style}
